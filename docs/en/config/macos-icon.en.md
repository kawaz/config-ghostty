---
description: Customize the macOS app icon appearance
platform: macos
default: official
---
...
* `custom` - Use a completely custom icon. The location must be specified using the additional [`macos-custom-icon`](macos-custom-icon.en.md) configuration
...
**WARNING:** The `custom-style` option is _experimental_. We may change the format of the custom styles in the future. We're still finalizing the exact layers and customization options that will be available.
...
# Customize the macOS app icon (default: official)
macos-icon = official
```

## Related

- [macos-custom-icon](macos-custom-icon.en.md)
- [macos-icon-ghost-color](macos-icon-ghost-color.en.md)
- [macos-icon-screen-color](macos-icon-screen-color.en.md)
