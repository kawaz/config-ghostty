---
description: Configure window decoration preference
platform: all
default: auto
---
...
**Language:** English | [日本語](../../ja/config/window-decoration.ja.md)
...
# Configure window decoration preference (default: auto)
