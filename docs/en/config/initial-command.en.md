---
description: Command to run in the first terminal surface
platform: all
default: (none)
---
...
**Language:** English | [日本語](../../ja/config/initial-command.ja.md)

## Description

This is the same as "command", but only applies to the first terminal surface created when Ghostty starts. Subsequent terminal surfaces will use the [`command`](command.en.md) configuration.
...
# Command to run in the first terminal surface (default: (none))
initial-command =
```

## Related

- [`command`](command.en.md)
