---
description: Delay before quitting after last window is closed
platform: linux
default: ""
---
...
**Language:** English | [日本語](../../ja/config/quit-after-last-window-closed-delay.ja.md)
...
# Delay before quitting after last window is closed (default: unset)
quit-after-last-window-closed-delay =
```
