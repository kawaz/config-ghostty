---
description: Load additional configuration files for Ghostty
platform: all
default: (none)
---
...
**Language:** English | [日本語](../../ja/config/config-file.ja.md)
...
# Load additional configuration files for Ghostty (default: (none))
config-file =
```

## Related

- [`config-default-files`](config-default-files.en.md)
