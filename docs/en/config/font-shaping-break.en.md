---
description: Control font shaping break points for text rendering
platform: all
default: "cursor"
---
...
**Language:** English | [日本語](../../ja/config/font-shaping-break.ja.md)
...
# Control font shaping break points for text rendering (default: cursor)
