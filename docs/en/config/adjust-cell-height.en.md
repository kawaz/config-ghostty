...
**Language:** English | [日本語](../../ja/config/adjust-cell-height.ja.md)
...
```conf
# https://ghostty.org/docs/config/reference#adjust-cell-height
# Adjust cell height for character alignment (default: "")
adjust-cell-height =
```
