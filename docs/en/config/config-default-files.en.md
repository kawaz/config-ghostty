---
description: Load default configuration file paths on startup
platform: all
default: "true"
---
...
**Language:** English | [日本語](../../ja/config/config-default-files.ja.md)
...
# Load default configuration file paths on startup (default: true)
