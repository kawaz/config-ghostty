---
description: Initial working directory for terminal
platform: all
default: ""
---
...
**Language:** English | [日本語](../../ja/config/working-directory.ja.md)
...
# Initial working directory for terminal (default: "")
working-directory =
```
