---
description: Initial window height in terminal grid cells
platform: all
default: "0"
---
...
**Language:** English | [日本語](../../ja/config/window-height.ja.md)
...
- [window-width](window-width.en.md)

## Default

```conf
# https://ghostty.org/docs/config/reference#window-height
# Initial window height in terminal grid cells (default: 0)
window-height = 0
```
