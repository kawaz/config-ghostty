---
description: Initial window width in terminal grid cells
platform: all
default: "0"
---
...
**Language:** English | [日本語](../../ja/config/window-width.ja.md)
...
- [window-height](window-height.en.md)

## Default

```conf
# https://ghostty.org/docs/config/reference#window-width
# Initial window width in terminal grid cells (default: 0)
window-width = 0
```
