---
description: Minimum contrast ratio for foreground and background colors
platform: all
default: "1"
---
...
**Language:** English | [日本語](../../ja/config/minimum-contrast.ja.md)
...
# Minimum contrast ratio for foreground and background colors (default: 1)
minimum-contrast = 1
```
