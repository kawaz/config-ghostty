---
description: Screen where quick terminal appears
platform: macos
default: main
---
...
**Language:** English | [日本語](../../ja/config/quick-terminal-screen.ja.md)
...
```conf
# https://ghostty.org/docs/config/reference#quick-terminal-screen
# Screen where quick terminal appears (default: main)
